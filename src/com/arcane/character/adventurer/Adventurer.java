...
public abstract class Adventurer extends Character {
    ...
    protected Adventurer(int health, int dodgeChance, Element resonanceElement, Element discordElement, AdventurerAcronym acronym) {
        this.health = health;
    ...
    protected void move(GameBoard gameBoard) {
        ...
        currentRoomId = RandomHelper.getRandomElementFromList(gameBoard.getRoom(currentRoomId).getConnectedRooms()).getRoomId();
    ...
    protected void fightCreatures(GameBoard gameBoard) {
        ...
        if (this.isAlive()) {
            ...
            List<Creature> creatures = new ArrayList<>(gameBoard.getRoom(this.currentRoomId).getCreatures());
    ...
    protected void searchTreasure() {
        if (baseTreasureRoll + Dice.rollDice() >= 10) {
            treasureCount += 1;
        }
    }
    ...
    public void addHealth(int health) {
        int updatedHealth = this.health+health;
        this.health = updatedHealth > 0 ? updatedHealth : 1;
    }
